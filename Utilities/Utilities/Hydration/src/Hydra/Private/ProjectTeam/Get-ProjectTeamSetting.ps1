<#
.SYNOPSIS
Get the project team settings for the given project

.DESCRIPTION
Get the project team settings for the given project. Includes iteration settings, but not the available iterations & area settings.
...
.EXAMPLE
Get-ProjectTeamSetting -organization 'contoso' -project 'Module Playground' -Team 'someTeam'

Get the project settings for team [contoso|Module Playground|someTeam]
#>
function Get-ProjectTeamSetting {
    ...
    $restInfo = Get-RelativeConfigData -configToken 'RESTTeamSettingsGet'
    $restInputObject = @{
