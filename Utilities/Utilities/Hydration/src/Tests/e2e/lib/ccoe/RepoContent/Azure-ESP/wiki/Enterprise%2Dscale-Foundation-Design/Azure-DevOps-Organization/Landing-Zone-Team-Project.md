...
Each Platform Team will receive a Landing Zone Team Project that will allow the to deploy and manage the workloads they are responsible for in their [Cloud-Native Landing Zone environment](/Foundation-Design/Cloud%2DNative-Landing-Zone.md) via pipelines.
