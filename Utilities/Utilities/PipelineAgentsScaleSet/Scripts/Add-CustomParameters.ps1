...
.EXAMPLE
Add-CustomParameters -parameterFilePath 'C:/parameter.json' -valueMap @( @{ Path = pathA;  Value = 'valueA'}, @{ Path = pathB; Value = 'valueB' })
...
.EXAMPLE
Add-CustomParameters -parameterFilePath 'C:/parameter.json' -valueMap @( @{ Path = pathA;  Value = 'valueA'; replaceToken = '[sasKey]'})
