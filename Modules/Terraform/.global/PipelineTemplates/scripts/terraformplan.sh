...
if [[ -d "$kitPath/Modules/Terraform/scripts" ]];
then
  echo "$kitPath/Modules/Terraform/scripts exists on your filesystem."
  ls $kitPath/Modules/Terraform/scripts

  #TODO - allow param for where the user wants to place this
  cp $kitPath/Modules/Terraform/scripts/* ./layer-$layerType
fi
